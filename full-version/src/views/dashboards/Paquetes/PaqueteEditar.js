...
export default function Content() {
  ...
  const PAQUETEID = localStorage.getItem('IDPAQUETE')
  ...
  useEffect(() => {
   ...
   if(!NombrePaquete){
    ...
    let payload2 = { 
      ...
      axios
        .post('http://eventcompany.somee.com/api/PaquetesEncabezado/TraerDatosPaquete', payload2)
        .then(response => {     
  
      
           
            setPrecioFinal(response.data.data.paqt_Precio)
            setNombrePaquete(response.data.data.paqt_Nombre)
    ...
    setIDPaqueteCreado(PAQUETEID);
         
    CargarDatosDDLElementos(PAQUETEID);
   
    CargarDatosDDLServicios(PAQUETEID);

    CargarDatostablaInventario(PAQUETEID);

    CargarDatostablaServicios(PAQUETEID)
  ...
  const CambiarNombre  = () => {
    ...
    axios
      .post('http://eventcompany.somee.com/api/PaquetesEncabezado/CambiarNombrePaquete', payload2)
      .then(response => {     

    
        if (response.data.data.codeStatus == 1)  {
         
            toast.success('Nombre del Paquete Editado Exitosamente', {
              duration: 4000
            });  
      ...
      setPrecioFinal(e)
         ...
         const InsertarPrecioFinal  = () => {
          ...
          if(PrecioNormal < PrecioFinal){
            ...
            toast.success('El Precio debe ser menor ', {
              duration: 4000
            });  
            return
          }
          ...
          axios
            .post('http://eventcompany.somee.com/api/PaquetesEncabezado/CambiarPrecioPaquete', payload2)
            .then(response => {     
