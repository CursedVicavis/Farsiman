  ...
  const doc = new jsPDF();
    ...
    useEffect(() => {
      ...
      const DatosFactura = () => {
        ...
        axios
          .post('http://eventcompany.somee.com/api/Facturas/ListarInfodeFactura', payload2)
          .then(response => {
    ...
    useEffect(() => {
      ...
      const DatosFacturaTabla = () => {
        ...
        axios
          .post('http://eventcompany.somee.com/api/Facturas/ListarTabladeFactura', payload2)
          .then(response => {
    ...
    const header = function (data) {
      ...
      // Agregar imagen
      doc.addImage('https://cdn.logojoy.com/wp-content/uploads/2018/05/30163918/1241-768x591.png', 'png', pageWidth-70, -15, 80, 80);
     ...
     ///////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      doc.autoTable({
        ...
        body: data.map((campos) => [
          ...
          campos.serv_Precio_Nuevo !== 0 ? campos.serv_Precio_Nuevo : (campos.inve_Precio !== 0 ? campos.inve_Precio : (campos.paqt_Precio !== 0 ? campos.paqt_Precio : '')),
          campos.serv_Precio_Nuevo !== 0 ? campos.serv_Precio_Nuevo : (campos.totalPrecioElemento !== 0 ? campos.totalPrecioElemento : (campos.paqt_Precio !== 0 ? campos.paqt_Precio : '')),
        ]),
