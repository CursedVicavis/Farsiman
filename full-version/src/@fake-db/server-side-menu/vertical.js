...
const navigation = [
  {
    ...
    children: [
      ...
      {
        title: 'Departamentos',
        path: '/dashboards/Departamentos'
      },
      {
        title: 'Municipios',
        path: '/dashboards/Municipios'
      },
      {
        title: 'Paquetes',
        path: '/dashboards/Paquetes'
      },
      {
        title: 'Servicios',
        path: '/dashboards/Servicios'
      },
      {
        title: 'Registro',
        path: '/dashboards/Registro'
      },
      {
        title: 'Pedidos',
      ...
      {
        title: 'Direcciones',
        path: '/dashboards/Direcciones'
      },
      {
        title: 'Tipo de pago',
        path: '/dashboards/TipoDePago'
      },
      {
        title: 'Estados Civiles',
        path: '/dashboards/Estados Civiles'
      },
      {
        title: 'Eventos',
        path: '/dashboards/Eventos'
      },
      {
        title: 'Empleados',
